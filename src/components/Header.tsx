...
const styles: Record<string, React.CSSProperties> = {
  header: { 
    ...
    boxShadow: '0 10px 40px rgba(0,0,0,0.6)', position: 'relative', overflow: 'hidden',
  ...
  // MAGIC FIX: flex: '1 1 100%' forces the pill to its own row on narrow screens
  navPill: { 
    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', 
    background: 'rgba(255,255,255,0.02)', padding: '8px 16px', borderRadius: '100px', 
    border: '1px solid rgba(255,255,255,0.05)', boxShadow: 'inset 0 0 20px rgba(0,0,0,0.5)',
    flex: '1 1 100%', overflowX: 'auto', whiteSpace: 'nowrap'
  },
  navDivider: { width: '4px', height: '4px', borderRadius: '50%', background: 'rgba(255,255,255,0.1)', flexShrink: 0 },
  
  navLink: { color: '#8b95a8', textDecoration: 'none', fontSize: '12px', fontWeight: 600, letterSpacing: '0.5px', transition: 'all 0.3s ease', cursor: 'pointer' },
  navLinkActive: { color: '#b9f2ff', textDecoration: 'none', fontSize: '12px', fontWeight: 700, letterSpacing: '0.5px', textShadow: '0 0 12px rgba(185,242,255,0.5)', transition: 'all 0.3s ease', cursor: 'pointer' },
  navLinkAccent: { color: 'rgba(212,175,55,0.8)', textDecoration: 'none', fontSize: '12px', fontWeight: 600, letterSpacing: '0.5px', transition: 'all 0.3s ease', cursor: 'pointer' },
  navLinkAccentActive: { color: '#FFD700', textDecoration: 'none', fontSize: '12px', fontWeight: 800, letterSpacing: '0.5px', textShadow: '0 0 16px rgba(255,215,0,0.6)', transition: 'all 0.3s ease', cursor: 'pointer' },
  navLinkDisabled: { display: 'none' }, // Hidden on mobile to save space
